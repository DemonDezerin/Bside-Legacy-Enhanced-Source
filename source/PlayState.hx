...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (PreferencesMenu.getPref('hpcolors'))
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		var red:FlxSprite = new FlxSprite(-100, -100).makeGraphic(FlxG.width * 2, FlxG.height * 2, 0xFF59B4FF);
	...
	override public function update(elapsed:Float)
	{
		...
		if (accuracy == 0 && !PreferencesMenu.getPref('oldui'))
